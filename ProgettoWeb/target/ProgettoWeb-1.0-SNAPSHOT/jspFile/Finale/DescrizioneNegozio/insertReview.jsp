...
<div style="display: flex; justify-content: center; align-items: center;">
    <form id="formReview" name="formReview" method="POST" action="${pageContext.request.contextPath}/InserisciRecensioneController?action=Negozio">
        ...
        <input type="hidden" id="oggettoReview" name="negozioReview" value="${negozio.getId()}"/>
