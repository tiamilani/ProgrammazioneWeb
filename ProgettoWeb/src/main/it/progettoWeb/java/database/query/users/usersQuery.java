...
public class usersQuery {
    ...
    public static String hello() {
        return "SELECT Negozio.*, imageNegozio.src AS imgNeg, Oggetto.id AS idOgg, Oggetto.nome AS nomeOgg, Oggetto.descrizione ,imageOggetto.src AS imgOgg
    ...
    public static String hello() {
        return "SELECT Ordine.*, Carrello.subtotale
    ...
    public static String hello() {
        return "SELECT RispostaVenditore.*
    ...
    public static String hello() {
        return "Create OR REPLACE View IDUInteressi as
    ...
    public static String hello() {
        return "INSERT INTO `progettoweb`.`Ordine`
    ...
    public static String hello() {
        return "UPDATE `progettoweb`.`Ordine`
    SET `stato` = '1'
    ...
    */
    ...
    public static String hello() {
        return "SELECT COUNT(idVenditore) AS counter
    FROM RecensioneVenditore
    ...
    public static String hello() {
        return "SELECT COUNT(idNegozio) AS counter
    FROM RecensioneNegozio
    ...
    public static String hello() {
        return "SELECT COUNT(idOggetto) AS counter
    FROM RecensioneVenditore
    WHERE RecensioneVenditore.idVenditore = 'idv' AND RecensioneVenditore.idUtente = 'idu';";
    }
    ...
    public static String hello() {
        return "INSERT INTO `progettoweb`.`Indirizzo`
