...
<div class="text-center">
    ...
    <form id="formReview" name="formReview" method="POST" enctype="multipart/form-data" action="${pageContext.request.contextPath}/InserisciRecensioneController?action=Negozio">
        ...
        <input type="hidden" id="negozioReview" name="negozioReview" value="${negozio.getId()}"/>
