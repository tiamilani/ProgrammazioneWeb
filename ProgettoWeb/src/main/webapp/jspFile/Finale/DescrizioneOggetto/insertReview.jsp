...
<div class="text-center">
    ...
    <form id="formReview" name="formReview" method="POST" enctype="multipart/form-data" action="${pageContext.request.contextPath}/InserisciRecensioneController?action=Oggetto">
