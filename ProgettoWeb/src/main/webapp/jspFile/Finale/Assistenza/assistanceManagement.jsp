                    ...
                    <c:forEach items="${assistenzeAperte}" var="assAperta">
                        <div class="row">
                            ...
                            per ogni richiesta di assistenza:
                                - nome+cognome utente che ha effettuato la richiesta
                                - nome+cognome venditore chiamato in causa (opzionale)
                                - nome oggetto chiamato in causa (opzionale)
                                - id ordine chiamato in causa (opzionale)
