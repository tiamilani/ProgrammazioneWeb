 ...
 */
package it.progettoWeb.java.database.Model.rispostaNegozio;

import java.util.Date;

/**
 * classe utilizzata per gestire gli oggetti di tipo Risposta negozio
 * @author mattia
 */
public class ModelloRispostaNegozio {
