 ...
 */
package it.progettoWeb.java.database.Model.rispostaOggetto;

import java.util.Date;

/**
 * classe utilizzata per gestire gli oggetti di tipo Risposta Oggetto
 * @author mattia
 */
public class ModelloRispostaOggetto {
