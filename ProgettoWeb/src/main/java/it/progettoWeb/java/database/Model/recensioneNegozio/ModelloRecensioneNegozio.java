...
/**
 * classe utilizzata per gestire gli oggetti di tipo RecensioneNegozio
 * @author mattia
 */
public class ModelloRecensioneNegozio {
    ...
    private int id;
    /**
     * Variabile utilizzata per identificare il negozio a cui si riferisce 
     */
    ...
    /**
     * Funzione utilizzata per ottenre l'id del negozio a cui è riferita la recensione
    ...
    /**
     * Funzione utilizzata per settare l'id del negozio a cui è riferita la recensione
     * @param idNegozio 
     */
