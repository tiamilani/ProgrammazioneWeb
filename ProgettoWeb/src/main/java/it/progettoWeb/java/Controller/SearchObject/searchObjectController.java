...
public class searchObjectController extends HttpServlet {
    ...
    /**
     * Costruttore della classe, inizializza un DaoOggetto
     */
 ...
 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ModelloListeOggetto listaOggetti = new ModelloListeOggetto(daoOggetto.selectObjectByName(search.toLowerCase()));
