...
SELECT *
FROM Oggetto JOIN Negozio ON Oggetto.idNegozio=Negozio.id
WHERE Negozio.id=ID AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM Oggetto JOIN Negozio ON Oggetto.idNegozio=Negozio.id
WHERE Negozio.id=ID AND Oggetto.categoria=CATEGORIA AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM Oggetto JOIN Negozio ON Oggetto.idNegozio=Negozio.id
WHERE Negozio.id=ID AND Oggetto.prezzo >= MINIMO AND Oggetto.nomeDownCase LIKE '%STRINGA%'

-- ottenere la lista di oggetti con un certo prezzo massimo con una certa stringa nel nome di un determinato negozio
SELECT *
FROM Oggetto JOIN Negozio ON Oggetto.idNegozio=Negozio.id
WHERE Negozio.id=ID AND Oggetto.prezzo <= MASSIMO AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM Oggetto JOIN Negozio ON Oggetto.idNegozio=Negozio.id
WHERE Negozio.id=ID AND Oggetto.prezzo BETWEEN MINIMO AND MASSIMO AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM Oggetto JOIN Negozio ON Oggetto.idNegozio=Negozio.id
WHERE Negozio.id=ID AND Oggetto.categoria=CATEGORIA AND Oggetto.prezzo >= MINIMO AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM Oggetto JOIN Negozio ON Oggetto.idNegozio=Negozio.id
WHERE Negozio.id=ID AND Oggetto.categoria=CATEGORIA AND Oggetto.prezzo <= MASSIMO AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM Oggetto JOIN Negozio ON Oggetto.idNegozio=Negozio.id
WHERE Negozio.id=ID AND Oggetto.categoria=CATEGORIA AND Oggetto.prezzo BETWEEN MINIMO AND MASSIMO AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM (Negozio JOIN Utente ON Utente.id=Negozio.idVenditore) JOIN Oggetto ON Negozio.id=Oggetto.idNegozio
WHERE Utente.UtenteType=1 AND Utente.id=ID AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM (Negozio JOIN Utente ON Utente.id=Negozio.idVenditore) JOIN Oggetto ON Negozio.id=Oggetto.idNegozio
WHERE Utente.UtenteType=1 AND Utente.id=ID AND categoria=CATEGORIA AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM (Negozio JOIN Utente ON Utente.id=Negozio.idVenditore) JOIN Oggetto ON Negozio.id=Oggetto.idNegozio
WHERE Utente.UtenteType=1 AND Utente.id=ID AND Oggetto.prezzo >= MINIMO AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM (Negozio JOIN Utente ON Utente.id=Negozio.idVenditore) JOIN Oggetto ON Negozio.id=Oggetto.idNegozio
WHERE Utente.UtenteType=1 AND Utente.id=ID AND Oggetto.prezzo <= MASSIMO AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM (Negozio JOIN Utente ON Utente.id=Negozio.idVenditore) JOIN Oggetto ON Negozio.id=Oggetto.idNegozio
WHERE Utente.UtenteType=1 AND Utente.id=ID AND Oggetto.prezzo BETWEEN MINIMO AND MASSIMO AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM (Negozio JOIN Utente ON Utente.id=Negozio.idVenditore) JOIN Oggetto ON Negozio.id=Oggetto.idNegozio
WHERE Utente.UtenteType=1 AND Utente.id=ID AND categoria=CATEGORIA AND Oggetto.prezzo >= MINIMO AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM (Negozio JOIN Utente ON Utente.id=Negozio.idVenditore) JOIN Oggetto ON Negozio.id=Oggetto.idNegozio
WHERE Utente.UtenteType=1 AND Utente.id=ID AND categoria=CATEGORIA AND Oggetto.prezzo <= MASSIMO AND Oggetto.nomeDownCase LIKE '%STRINGA%'
...
SELECT *
FROM (Negozio JOIN Utente ON Utente.id=Negozio.idVenditore) JOIN Oggetto ON Negozio.id=Oggetto.idNegozio
WHERE Utente.UtenteType=1 AND Utente.id=ID AND categoria=CATEGORIA AND Oggetto.prezzo BETWEEN MINIMO AND MASSIMO AND Oggetto.nomeDownCase LIKE '%STRINGA%'
